...
show_avatar | If you have a valid avatar in the _config.yml but you don't want to appear on every page you can turn it on with this flag. Note: the specific value doesn't matter only whether it's defined or not.
